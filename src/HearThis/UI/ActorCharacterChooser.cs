	...
	public partial class ActorCharacterChooser : UserControl
	{
		...
		public IActorCharacterProvider ActorCharacterProvider
		{
			...
			set
			{
				...
				_actorList.Items.Add(LocalizationManager.GetString("ActorChooser.Overview", "Overview", "Item appears at top of list of actors and means to show everything for all actors"));
