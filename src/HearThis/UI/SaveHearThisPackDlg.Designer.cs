namespace HearThis.UI
{
	partial class SaveHearThisPackDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.aboutHearThisPack.Text = "A HearThisPack compresses all your recordings into a single file that can be shar" +
    "ed with others working on the same project. Make sure you have the same exact ve" +
    "rsion of the project!";
			// 
