...
namespace HearThis.UI
{
	...
	public class SkipButton : CheckBox
	{
		private Image normal;
		private Image highlighted;
		private Image pressed;
		private Image highlightedAndPressed;
		...
		public SkipButton()
		{
			...
			normal = Resources.SkipArrow;
			highlighted = Resources.SkipArrowHighlighted;
			pressed = Resources.SkipArrowPressed;
			highlightedAndPressed = Resources.SkipArrowHighlightedWhenSkipped;
			Image = normal;
		}
		...
		protected override void OnCheckedChanged(EventArgs e)
		{
			...
			if (MouseIsOverButton)
				Image = Checked ? highlightedAndPressed : highlighted;
			else
				Image = Checked ? pressed : normal;
			Invalidate();
		}
		...
		{
			OnPaintBackground(pevent);
			pevent.Graphics.DrawImage(Image, pevent.ClipRectangle);
		}
